...
/**
 * This is the interface for text that has markup(标记，markup language标记语言) objects attached to
...
{
    /**
     * Bitmask(位掩码，位屏蔽，位元遮罩) of bits that are relevent for controlling point/mark behavior
     * of spans.
     *
