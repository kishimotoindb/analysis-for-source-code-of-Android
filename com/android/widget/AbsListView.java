...
public abstract class AbsListView extends AdapterView<ListAdapter> implements TextWatcher,
    ...
    View obtainView(int position, boolean[] isScrap) {
        ...
        // 1. 如果有 transient view ，那么直接使用，并且不会更新 view 的 ui。需要确定 transient view
        // 到底是怎么定义的？
        ...
        // 2. 如果是没有 transient view，那么看recycler中是否有可复用的view。但是不论是否有可复用的view，
        // 都会通过 getView() 方法更新 UI
    ...
    class RecycleBin {
        ...
        // position作为key，应该是在 layout 过程中用来保存列表中view的容器，注意 !dataSetChange
