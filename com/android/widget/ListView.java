...
public class ListView extends AbsListView {
     ...
     */
    @Override
	//setAdapter()方法，不但是把adapter提供给了ListView，也是ListView将自己的observer提供
	//给了adapter，双向操作，不是表面看起来的只是ListView里set了一个adapter。
    public void setAdapter(ListAdapter adapter) {
		//ListView可以重复设置适配器
		//在设置适配器之前，会把原来的适配器和observer清空，并注销observer
        if (mAdapter != null && mDataSetObserver != null) {
        ...
        if (mAdapter != null) {
			...
			//创建一个新的observer，并注册到adapter的observable中。
