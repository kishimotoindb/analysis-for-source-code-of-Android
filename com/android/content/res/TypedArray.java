...
public class TypedArray {
    ...
    /*package*/ int[] mRsrcs;
    /*package*/ int[] mData;
    /*package*/ int[] mIndices;	//index 0：存储TypedArray中数据的数量，index 1~无穷：存储数据的索引，系统拿到这个索引就可以通过该类的getValue得到
								//实际的属性值。
								//indice是标记体的意思
								
    /*package*/ int mLength;  	//typedArray的元素数量
    /*package*/ TypedValue mValue = new TypedValue();  	//Container for a dynamically typed data value.  Primarily used with
